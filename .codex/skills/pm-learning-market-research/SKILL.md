...
2. Define role scope: AI PM, AI solution, FDE, LLM platform PM, or local industry AI role.
...
- AI product manager, AI solution consultant, FDE, LLM platform PM, RAG/Agent product roles.
